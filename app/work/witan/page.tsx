          ...
          <CaseStudyCanvas className="w-full max-w-[560px] mx-auto py-8 lg:py-[60px] text-neutral-800 dark:text-neutral-200 [&_p:not(.uppercase):not(.font-semibold):not(.font-medium)]:text-neutral-600 dark:[&_p:not(.uppercase):not(.font-semibold):not(.font-medium)]:text-neutral-400">
              ...
              <div className="flex flex-col gap-10 max-w-[560px] mx-auto">
                ...
                <div className="w-full flex flex-col divide-y divide-neutral-100 dark:divide-neutral-800">
                  <div className="flex items-center justify-between gap-6 py-3">
                    ...
                    <p className="text-sm text-neutral-400 text-right">2022–2023</p>
                  </div>
                  <div className="flex items-center justify-between gap-6 py-3">
                    <p className="text-sm text-[lab(2.75381_0_0)] dark:text-neutral-200 font-medium">My role</p>
                    <p className="text-sm text-neutral-400 text-right">Product Design, Interaction Design, Usability Testing</p>
                  </div>
                  <div className="flex items-center justify-between gap-6 py-3">
                    <p className="text-sm text-[lab(2.75381_0_0)] dark:text-neutral-200 font-medium">Industry</p>
                    <p className="text-sm text-neutral-400 text-right">Events / Web3</p>
                  </div>
                  <div className="flex items-center justify-between gap-6 py-3">
            ...
            <section id="background" className="mb-16">
              <div className="w-full max-w-[560px] mx-auto">
                ...
                <blockquote className="text-base font-normal text-neutral-600 dark:text-neutral-400 border-l-4 border-neutral-200 dark:border-neutral-800 pl-5 mb-6">
            ...
            <section id="summary" className="mb-16">
              <div className="w-full max-w-[560px] mx-auto">
                ...
                <ul className="text-sm leading-relaxed text-neutral-600 dark:text-neutral-400 space-y-4 list-disc list-outside pl-5">
                  <li>
                    <strong className="text-neutral-600 dark:text-neutral-400 font-medium">Onboarding difficulties</strong> — users find it hard to sign up on existing platforms like Eventbrite due to unavailability of mobile verification options for Nigerians.
                  </li>
                  <li>
                    <strong className="text-neutral-600 dark:text-neutral-400 font-medium">Ticket fraud and duplicates</strong> — organizers have experienced major challenges with cases where tickets are resold or reused during events.
                  </li>
                  <li>
                    <strong className="text-neutral-600 dark:text-neutral-400 font-medium">Audience reach</strong> — due to low penetration of ticketing platforms in Nigeria, there&apos;s low discoverability of events and organizers are unable to optimize for reach and profit.
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-16">
              <div className="w-full max-w-[560px] mx-auto">
                ...
                <p className="text-sm leading-relaxed text-neutral-600 dark:text-neutral-400 mb-4">This gave rise to many questions:</p>
                <ol className="text-sm leading-relaxed text-neutral-600 dark:text-neutral-400 space-y-2 list-decimal list-outside pl-5 mb-6">
                ...
                <blockquote className="text-sm font-normal text-neutral-600 dark:text-neutral-400 border-l-4 border-neutral-200 dark:border-neutral-800 pl-5">
