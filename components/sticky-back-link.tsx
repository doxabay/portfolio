...
export default function StickyBackLink() {
  return (
    <Link
      href="/"
      className="inline-flex items-center gap-2 text-sm text-[lab(35.1166_1.78212_-6.1173)] hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 mb-8"
    >
